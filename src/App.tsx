      ...
      return (
        <div className="min-h-screen bg-black text-white flex items-center justify-center p-6">
          <div className="w-full max-w-md">
            <div className="bg-gray-800/50 backdrop-blur-sm border border-blue-500/30 rounded-lg p-8">
              ...
              <div className="mt-6 text-center">
                <button
                  onClick={() => setShowSecretGenerator(false)}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-3xl font-bold text-white pixel-font" style={{ fontFamily: "'Press Start 2P', monospace" }}>
                Sign-up Generator
              </h1>
            </div>
          ...
          {/* Generate Button */}
          <div className="bg-gray-800/50 backdrop-blur-sm border border-blue-500/30 rounded-lg p-6 mb-8">
    ...
    <div className="min-h-screen bg-black text-white overflow-hidden relative">
      ...
      <div className="absolute top-8 left-8 z-10">
        <div className="flex items-center">
          <span className="pixel-font text-sm md:text-lg tracking-wider text-white" style={{ fontFamily: "'Press Start 2P', monospace" }}>
            {topLeftText}
          </span>
          {showTopCursor && (
      ...
      <div className="min-h-screen flex flex-col items-center justify-center px-6">
        ...
        <div className="flex flex-col items-center space-y-8">
          <div className="flex items-center justify-center min-h-[80px]">
            <span className="pixel-font text-xl md:text-3xl lg:text-4xl text-center tracking-wide" style={{ fontFamily: "'Press Start 2P', monospace" }}>
              {centerText}
            </span>
            {showCenterCursor && (
          ...
          <div className={`transition-all duration-1000 ease-out transform ${
            ...
            <div className="flex flex-col space-y-4">
              ...
              <button 
                ...
                className="group relative px-8 py-4 bg-transparent border-2 border-blue-400 pixel-font text-xs tracking-wider uppercase transition-all duration-300 hover:bg-blue-400 hover:text-black hover:shadow-2xl hover:shadow-blue-400/20 active:scale-95" 
                style={{ fontFamily: "'Press Start 2P', monospace" }}
              >
                {/* Glitch effect on hover */}
                <span className="relative z-10 flex items-center space-x-3">
                ...
                {/* Subtle glow effect */}
                <div className="absolute inset-0 bg-blue-400/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-sm" />
              </button>
            </div>
          </div>
        </div>
