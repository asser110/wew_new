  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden relative">
      ...
      <div className="absolute top-8 right-8 z-10">
        <span className="pixel-font text-sm tracking-wider text-white/80">
          clutch
        </span>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-gray-900/50 backdrop-blur-sm border border-white/20 p-8 relative">
            ...
            <div className="text-center mb-8">
              <h1 className="pixel-font text-lg mb-2 tracking-wide">
                {step === 'login' ? 'Welcome Back' : 'Verify Email'}
              </h1>
              <p className="pixel-font text-xs text-gray-400 tracking-wider">
            ...
            {error && (
              <div className="mb-6 p-3 bg-red-900/50 border border-red-500/50 text-red-300">
                <p className="pixel-font text-xs tracking-wider">
                  {error}
                </p>
              </div>
            )}
            ...
            {step === 'login' ? (
              ...
              <form onSubmit={handleLogin} className="space-y-6">
                ...
                <div className="space-y-2">
                  <label className="pixel-font text-xs tracking-wider text-gray-300 uppercase">
                    Email
                  </label>
                ...
                <div className="flex items-center justify-between">
                  <label className="flex items-center space-x-2 cursor-pointer">
                    ...
                    />
                    <span className="pixel-font text-xs tracking-wider text-gray-400">
                      Remember
                    </span>
                  </label>
                  <button
              ...
              <form onSubmit={handleVerification} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="pixel-font text-xs text-gray-500 tracking-wider">
            ...
            {step === 'login' && (
              ...
              <div className="mt-8 text-center">
                <p className="pixel-font text-xs tracking-wider text-gray-400">
